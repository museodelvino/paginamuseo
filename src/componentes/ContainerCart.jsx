  ...
  return (
    <div>
      ...
      {items.map( i => <tr>
        ...
        <td className="cart-table">${formatPrice(i.price * i.quantity)}</td>
        <td className=" hover:bg-red-400">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:cursor-pointer" onClick={() => removeItem(items.id)}>
      ...
      <tr>
        ...
        <th scope="col"></th>
        <th scope="col"></th>
        <th scope="col">${formatPrice(getTotal())}</th>
        </tr>
      </tbody>
      </table>
